...
namespace DigitalRuby.LightningBolt
{
    ...
    public class LightningBoltScript : MonoBehaviour
    {
        ...
        [Range(0.01f, 30f)]
        public float lazerDistance = 10f;
        ...
        [SerializeField] private Beholder script;
        ...
        public void Trigger()
        {
            ...
            if (EndObject == null)
            {
                end = start + transform.forward * lazerDistance;
            }
            else
            {
       ...
       void Ray()  //追加関数 Trigger関数の射程追加
        {
            ...
            Debug.DrawRay(ray.origin, end-start, Color.red, 0.1f,false);
